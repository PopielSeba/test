  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Tworzenie Nowej Wyceny</h1>
          <p className="text-gray-600 mt-2">Wypełnij poniższe informacje, aby utworzyć nową wycenę dla klienta</p>
        </div>
