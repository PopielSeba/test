      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <EquipmentMaintenanceDefaultsCard equipment={equipment} />
...
function EquipmentMaintenanceDefaultsCard({ equipment }: { equipment: Equipment[] }) {
  ...
  useEffect(() => {
    if (maintenanceDefaults) {
      form.reset({
        fuelFilter1Name: maintenanceDefaults.fuelFilter1Name,
        fuelFilter1Cost: maintenanceDefaults.fuelFilter1Cost,
        fuelFilter2Name: maintenanceDefaults.fuelFilter2Name,
        fuelFilter2Cost: maintenanceDefaults.fuelFilter2Cost,
        oilFilterName: maintenanceDefaults.oilFilterName,
        oilFilterCost: maintenanceDefaults.oilFilterCost,
        airFilter1Name: maintenanceDefaults.airFilter1Name,
        airFilter1Cost: maintenanceDefaults.airFilter1Cost,
        airFilter2Name: maintenanceDefaults.airFilter2Name,
        airFilter2Cost: maintenanceDefaults.airFilter2Cost,
        engineFilterName: maintenanceDefaults.engineFilterName,
        engineFilterCost: maintenanceDefaults.engineFilterCost,
        oilCost: maintenanceDefaults.oilCost,
        oilQuantity: maintenanceDefaults.oilQuantity,
        serviceWorkHours: maintenanceDefaults.serviceWorkHours,
        serviceWorkRate: maintenanceDefaults.serviceWorkRate,
        maintenanceInterval: maintenanceDefaults.maintenanceInterval,
      });
    }
  }, [maintenanceDefaults, form]);
  ...
  const updateMaintenanceDefaultsMutation = useMutation({
    mutationFn: async (data: z.infer<typeof equipmentMaintenanceSchema>) => {
      ...
      await apiRequest(`/api/equipment/${selectedEquipment.id}/maintenance-defaults`, {
        method: "PUT",
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Konfiguruj domyślne wartości eksploatacji dla każdego urządzenia osobno
        </p>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
